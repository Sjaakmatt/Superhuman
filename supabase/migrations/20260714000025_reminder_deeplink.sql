-- Notificaties dieper linken: blok-reminders dragen nu het blok-`kind` mee,
-- zodat de push-payload naar de juiste route kan wijzen (bv. avondeten →
-- /voeding, workout → /beweging/sessie/auto) i.p.v. altijd /vandaag.
...
-- Backfill: herbouw bestaande blok-reminders mét blockKind voor alle users.
